  ...
  <div class="col-sm-6 col-md-12">
    ...
    <div class="cell py-4">
      <span class="text-center">
        ...
        <div class="badge badge-light">$10 value</div>
      </span>
    </div>
  </div>
  <div class="col-sm-6 col-md-12 feature-cells">
    <div class="cell">
      <p>Pro Access</p>
    </div>
    <div class="cell">
      <p class="text-primary"><strong>Unlimited Downloads</strong> <small><i class="mdi mdi-information-outline mute" data-toggle="tooltip" data-placement="right" title="Limited time. Early bird sale."></i></small></p>
    </div>
    <div class="cell">
