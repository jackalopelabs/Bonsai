    ...
    <div class="">
      <div class="menu flex-c-c">
        <div class="nav-md row">
          ...
          {{-- <button class="mobile-menu flex-col-c p-3 ml-2" data-toggle="modal" data-target="#navModal">•••</button> --}}
        </div>
      </div>
    </div>
  </div>
...
<div id="navCornerCta" class="mt-5 fixed-bottom mr-4" style="left: inherit;">
  <div class="mb-5 ml-5">
    ...
    <div class="mt-2">
      <small class="badge badge-light uppercase text-muted" style="">Ends March 1st, 2020 </small>
    </div>
